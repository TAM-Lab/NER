...
def readfile(filename):
    ...
    for line in f:
        ...
        if line.split("\t")[0] == '　' or line.split("\t")[0] == " " or line[0] == "\n":
            continue
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        return ["0", "B_DRUG", "I_DRUG", "B_DRUG_GROUP", "I_DRUG_GROUP", "B_DRUG_INGREDIENT", "I_DRUG_INGREDIENT", "B_DISEASE_GROUP",
                "I_DISEASE_GROUP", "B_SYNDROME", "I_SYNDROME", "B_DRUG_DOSAGE", "B_SYMPTOM", "I_SYMPTOM", "I_DRUG_DOSAGE", "B_FOOD_GROUP", "I_FOOD_GROUP",
                "B_DRUG_TASTE", "I_DRUG_TASTE", "B_DRUG_EFFICACY", "I_DRUG_EFFICACY", "B_PERSON_GROUP", "I_PERSON_GROUP",
                "B_DISEASE", "I_DISEASE", "B_FOOD", "I_FOOD", "[CLS]", "[SEP]"]
